...
- modes:
  1. single: degrades a single video
    ...
    example:
    ```
    python dataset/degrade_video_albu.py --input_root ../dataset/GOT10/test/GOT-10k_Test_000001/ \ --output_root data/GOT10/test --make_video --mode single  --config_path dataset/aug_strong.yaml 
    ```
