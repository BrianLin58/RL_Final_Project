...
from calc_similarity import calc_weighted_miou_from_boxes
...
class VideoEnv(Env):
    ...
    def step(self, action):
        ...
        miou_before = calc_weighted_miou_from_boxes(self.gt_boxes, self.lq_boxes, self.frame_index)
        miou_after  = calc_weighted_miou_from_boxes(self.gt_boxes, self.perturbed_boxes, self.frame_index)
